...
export const homeContent = [
    ...
    },
    {
        ...
        wrapperClassName:
            'bg-gradient-to-r from-blue-500 to-blue-700 shadow-2xl',
    },
    {
    ...
    },
    {
        ...
        className: 'font-sans font-light text-white text-lg lg:text-xl',
        wrapperClassName:
            'bg-gradient-to-r from-blue-800 to-blue-900 shadow-2xl',
    },
    {
...
export const contactContent = {
    intro: 'To get in touch, please send me a message on linkedin, discord, or using the form below!',
    socialLinks: {
