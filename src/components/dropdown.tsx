...
const Dropdown: React.FC<DropdownProps> = ({options, onSelect}) => {
    ...
    return (
        <div className="relative flex flex-col rounded-2xl w-[300px] h-fit mx-auto my-2">
            <button className={`py-2 px-4 rounded-2xl font-sans active:bg-blue-800 w-full 
            ...
            {isOpen && (
                <div className="absolute top-12 flex flex-col items-start rounded-2xl p-2 w-full
                                bg-blue-800">
